...
test:
	./build/compiler -koopa testing/0_empty.sysy -o testing/0_empty.out
	./build/compiler -koopa testing/1_main.sysy -o testing/1_main.out
	# ./build/compiler -koopa testing/2_wrong.sysy -o testing/2_wrong.out
	./build/compiler -riscv testing/1_main.sysy -o testing/1_main.s
	./build/compiler -koopa testing/3_unary.sysy -o testing/3_unary.out
	./build/compiler -riscv testing/3_unary.sysy -o testing/3_unary.s
	./build/compiler -koopa testing/4_complex_unary.sysy -o testing/4_complex_unary.out
	./build/compiler -koopa testing/5_add.sysy -o testing/5_add.out
	./build/compiler -koopa testing/6_lt.sysy -o testing/6_lt.out
