...
autotest: `autotest -koopa -s lv1 /root/compiler`
autotest: `autotest -riscv -s lv1 /root/compiler`
manual: `./build/compiler -koopa ./testing/ -o ./testing/`
manual: `./build/compiler -riscv ./testing/ -o ./testing/`
run: `clang ./testing/36_arr_params.s -c -o hello.o -target riscv32-unknown-linux-elf -march=rv32im -mabi=ilp32`
run: `ld.lld hello.o -L$CDE_LIBRARY_PATH/riscv32 -lsysy -o hello`
run: `qemu-riscv32-static hello`